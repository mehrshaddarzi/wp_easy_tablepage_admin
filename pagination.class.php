...
*/
		...
		function show(){
				if(!$this->calculate)
					if($this->calculate())
						echo "<div class=\"$this->className\" style='min-width: 700px;'>$this->pagination</div>\n";
			}
		function getOutput(){
				if(!$this->calculate)
					if($this->calculate())
						return "<div class=\"$this->className\" style='min-width: 700px;'>$this->pagination</div>\n";
			}
		...
		function calculate($show = 'all'){
				...
				*/
				...
				if ($show =='number_all') { return $lastpage; } else {
